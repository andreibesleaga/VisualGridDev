...
| IEEE CertifAIEd | Programme based on the IEEE 7000 series | <https://certification.ieee.org/certifai> | Confirm the targeted programme revision; the mapping in this repository does not claim certification. |
